...
World 1: **Party Invites** is a tutorial world that is meant to introduce you to the logical \"and\". The symbol used to denote an \"and\" looks like a hat `∧`. You'll learn to how to use evidence to create an `∧` and how also how to get evidence out when it's been `∧`ed together.\\
\\
